...
def init(nme, d_original, d_class, dc, factor, red_dim):
    print(" nme:", nme, "\n", "dc:", dc, "\n", "red_dim:", red_dim, "\n", "factor:", factor)
    fn1 = nme + "/" + nme + "_" + "dn3mf1" + "_b_" + str(factor) + ".txt"
    f1 = open(fn1, "r")
    ...
    j += 1
    i = 4
    clustering(sheet, i, "dn3mf1_b", d1, d_class, nc, nme, factor)   
    book.save(nme + "/" + nme + "_cluster_performance_dn3mf1_" + str(dc) + "_" + str(red_dim) + "_" + str(factor) + ".xls")
