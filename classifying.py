...
def init(nme, d_original, d_class, dc, factor, red_dim):
    ...
    i = 1
    classify(sheet, i, "dn3mf1_b", d1, d_class)
    book.save(nme + "/" + nme + "_classify_performance_dn3mf1_" + str(dc) + "_" + str(red_dim) + "_" + str(factor) + ".xls")
...
if __name__ == '__main__':
    data_choice = 3 # 1: GastrointestinalLesionsInRegularColonoscopy, 2: OnlineNewsPopularity, 3: ParkinsonsDiseaseClassification
    f = 0.25
    main(data_choice, f)
